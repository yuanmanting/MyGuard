...
//iojji
  ...
  private void initView(){
      ...
      mRemindIMGY=(ImageView) findViewById(R.id.imgv_traffic_remind);
  ...
  private void initData(){
      ...
      if(totalflow>0&usedflow>=0){
          ...
          if(scale>0.9){
              mRemindIMGY.setEnabled(false);
              mRemindTV.setText("您的套餐流量即将用完！");
          }else{
              mRemindIMGY.setEnabled(true);
    ...
    public void onClick(View v) {
      switch (v.getId()){
          ...
          case R.id.btn_correction_flow:
              ...
              switch (i){
                  case 0:
                      Toast.makeText(this,"您还没设置运营商信息",0).show();
                      break;
                  case 1:
